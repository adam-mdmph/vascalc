...
clti_mort_30 = reactive({
  	...
  	age_3 = ifelse(input$age_p > 80, 1, 0)
		...
		# Guessed at intercept - reported in paper that baseline was 99.7%
		clti_term_30 = -5.9 + age_1*0.51 + age_2*0.97 + age_3*1.5 + race_1*-0.38 + indication_1*0.42 + cad_1*0.25 + 
...
clti_mort_2y = reactive({
  	...
  	age_3 = ifelse(input$age_p > 80, 1, 0)
		...
		statin_1 = ifelse(3 %in% input$preopmeds_p, 1, 0)
		# Guessed at intercept - reported in paper that baseline was 95.2%
		clti_term_2y = -2.98 + age_1*0.32 + age_2*0.68 + age_3*1.17 + race_1*-0.25 + indication_1*0.43 + tob_1*0.09 +
