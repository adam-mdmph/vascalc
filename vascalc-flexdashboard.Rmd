...
renderValueBox({
  ...
  evar_mort_hosp = ifelse(input$prioraorta_a == 1, "Unable to calculate", 
    						scales::percent(evar_mort_hosp(), accuracy = 0.1))
  valueBox(
    value = evar_mort_hosp,
    icon = "fa-syringe",
    color = ifelse(input$prioraorta_a == 1, "grey",
...
renderValueBox({
  ...
  open_mort_hosp = ifelse(input$prioraorta_a == 1, "Unable to calculate", 
